...
// motor groups
pros::MotorGroup leftMotors({-15, -13, -12},
...
void autonomous() {
    ...
    chassis.moveToPoint(0, 26, 2000,{.maxSpeed = 90, .minSpeed = 0.1});
    pros::delay(200);
    scraper.set_value(true);
    chassis.turnToHeading(88, 500, {.maxSpeed = 89});
    chassis.moveToPoint(12, 30, 2000,{.maxSpeed = 90, .minSpeed = 0.1});
    chassis.waitUntilDone();
    pros::delay(250);
    chassis.moveToPoint(-17, 31, 1000,{.forwards = false ,.maxSpeed = 90, .minSpeed = 0.1});
    chassis.waitUntilDone();
